...
class MyOrderScreenController extends GetxController {
  ...
  RxString SubHeadingText1 =
      RxString('Order the product and is delivery based on location');
  RxString SubHeadingText2 =
      RxString('Order the product and is delivery based on location');
  RxString SubHeadingText3 =
      RxString('Order the product and is delivery based on location');
  RxString SubHeadingText4 =
      RxString('Order the product and is delivery based on location');
  RxString SubHeadingText5 =
      RxString('Order the product and is delivery based on location');
