...
//
//     final offersClickModel = offersClickModelFromJson(jsonString);

import 'dart:convert';

OffersClickModel offersClickModelFromJson(String str) => OffersClickModel.fromJson(json.decode(str));
...
class OffersClickModel {
    ...
    factory OffersClickModel.fromJson(Map<String, dynamic> json) => OffersClickModel(
        ...
        error: json["error"],
        data: List<OffersClickData>.from(json["data"].map((x) => OffersClickData.fromJson(x))),
    );
...
class OffersClickData {
    ...
    factory OffersClickData.fromJson(Map<String, dynamic> json) => OffersClickData(
        ...
        productMainCategoryId: json["productMainCategoryId"]??'',
