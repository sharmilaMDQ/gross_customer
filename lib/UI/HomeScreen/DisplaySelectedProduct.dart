...
//
class DisplaySelectedProduct extends GetView<DisplaySelectedProductController> {
  DisplaySelectedProduct({super.key});

  @override
  Widget build(BuildContext context) {
    double height = MediaQuery.of(context).size.height;
    double width = MediaQuery.of(context).size.width;
    DisplaySelectedProductController Controller = Get.put(DisplaySelectedProductController());

    WidgetsBinding.instance?.addPostFrameCallback((_) {
      controller.SelectedScreenApi();
      // controller.GetCartApi();
    });
    return GetBuilder<DisplaySelectedProductController>(
      init: DisplaySelectedProductController(),
      builder: (controller) {
        return Theme(
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(Controller.userDataProvider.wishListProducts?.productPrice ?? "",
                                  style: GoogleFonts.poppins(
                                    color: AppTheme.Buttoncolor,
                                    fontSize: 20,
                                    fontWeight: FontWeight.w600,
...
// }
                            if (Controller.CartProdct.isNotEmpty) {
                              if (controller.userDataProvider.wishListProducts!.sellerId == controller.CartProdct[0].sellerId) {
                                controller.CartApi(context);
                              } else {
                          ...
                          children: [
                            ...
                            Stack(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Image.network(
                                    Controller.userDataProvider.wishListProducts?.productImage ?? "",
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(Controller.userDataProvider.wishListProducts?.productName ?? "",
                                      style: GoogleFonts.poppins(
                                        color: Colors.black,
                                        fontSize: 14,
                                        fontWeight: FontWeight.w600,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(Controller.userDataProvider.wishListProducts?.productDescription ?? "",
                                        style: GoogleFonts.poppins(
                                          color: Colors.black,
                                          fontSize: 14,
                                          fontWeight: FontWeight.w600,
                            ...
                            Obx(
                              () => Padding(
                                ...
                                child: controller.Selectedproduct.value.isNotEmpty
                                    ? SingleChildScrollView(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  WishlistScreenCommonComponent(
                                                    productimage: controller.Selectedproduct[index].productImage ?? "",
                                                    productname: controller.Selectedproduct[index].productName ?? "",
                                                    productprice: controller.Selectedproduct[index].productPrice ?? "",
                                                    shopName: "",
                                                    productQty: controller.Selectedproduct[index].productQty ?? "",
                                                    productCategory: controller.Selectedproduct[index].mainCategory ?? "",
                                                    onTap: () {},
                                                    isFavaurite: false,
