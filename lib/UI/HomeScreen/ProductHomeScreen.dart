                ...
                onPressed: () {
                  cartcontroller.GetCartApi().then((data) {
                   Future.delayed(Duration(milliseconds: 2000),(){
                     Get.to(() => CartScreen(total: cartcontroller.total.value,));
                   });
                  });
                },
                icon: Stack(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    controller.counter.length > index &&
                                            controller.counter[index].value > 0
                                        ? Row(
                                            children: [
                                              // Decrement button
                                              InkWell(
                                                onTap: () {
                                                  if (controller.counter.length > index &&
                                                      controller.counter[index].value > 0) {
                                                    Helper.productID = product.productId!;
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    color: controller.counter.length > index &&
                                                            controller.counter[index].value > 0
                                                        ? Colors.red
                                              ...
                                              Text(
                                                controller.counter.length > index
                                                    ? controller.counter[index].value.toString()
                                                    : '0',
                                                style: TextStyle(
                                                  fontSize: 12,
                                                  fontWeight: FontWeight.w400,
